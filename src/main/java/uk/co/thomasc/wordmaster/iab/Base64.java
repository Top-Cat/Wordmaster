...
public class Base64 {
	...
	public static String encode(byte[] source) {
		return Base64.encode(source, 0, source.length, Base64.ALPHABET, true);
	}
	...
	public static String encodeWebSafe(byte[] source, boolean doPadding) {
		return Base64.encode(source, 0, source.length, Base64.WEBSAFE_ALPHABET, doPadding);
	}
	...
	public static byte[] decode(byte[] source, int off, int len)
			throws Base64DecoderException {
		return Base64.decode(source, off, len, Base64.DECODABET);
	}
	...
	public static byte[] decodeWebSafe(byte[] source, int off, int len)
			throws Base64DecoderException {
		return Base64.decode(source, off, len, Base64.WEBSAFE_DECODABET);
	}
						...
						if (b4Posn == 0 || b4Posn == 1) {
							...
							throw new Base64DecoderException(
									"padding byte '=' falsely signals end of encoded value "
											+ "at offset " + i);
						} else if (lastByte != Base64.EQUALS_SIGN && lastByte != Base64.NEW_LINE) {
							throw new Base64DecoderException(
