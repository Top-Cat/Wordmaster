...
public class GameAdapter extends ArrayAdapter<Turn> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int viewId = item.getTurnNum() == 0 ? R.layout.game_row_word : (isPlayer ? (winningTurn ? R.layout.game_row_win : R.layout.game_row_big) : (winningTurn ? R.layout.game_row_lose : R.layout.game_row_small));
